...
# Mostrar archivos en el entorno para debug (opcional, elimina después)
...
if "auth_email" in st.session_state:
    ...
    promo1 = st.number_input("Promos 3x10 TAPPO", min_value=0, key=st.session_state.widget_key_promos + "_1")  # Cambiado el texto aquí
